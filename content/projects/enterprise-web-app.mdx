...
As a Software Engineering Intern at Softworld, I contributed to building a production-grade enterprise web application serving internal business operations. The application features a sophisticated multi-schema PostgreSQL database architecture, type-safe server-side operations, and granular file-based access control.
...
-   **Security** - Sensitive business data demands robust access control and validation
...
-   **Business context** - Understanding how technical decisions impact business outcomes
