...
export const experiences: Experience[] = [
  {
    ...
    tech: ['Next.js', 'PostgreSQL', 'Drizzle ORM', 'Zod', 'TypeScript', 'Docker', 'Tailwind CSS'],
  },
  {
    company: 'Freelance',
    ...
    tech: ['Next.js', 'React', 'Node.js', 'MongoDB', 'Express.js', 'Stripe', 'Vercel', 'TypeScript'],
  },
  {
    ...
    description: [
      ...
      'Collaborated with senior developers to implement React components following established design system guidelines',
    ],
