			...
			<div className="container mx-auto">
				...
				<div className="mb-12 text-center">
					<h2 className="text-4xl md:text-5xl font-bold mb-4">
						<span className="bg-gradient-primary bg-clip-text text-transparent">Experience Timeline</span>
					</h2>
							...
							<div key={`${experience.company}-${index}`} className="relative">
								...
								<Card variant="hover" padding="md" className="h-full">
									<div className="text-center">
										...
										{/* Position */}
										<p className="text-text-secondary text-sm mb-4">{experience.position}</p>

										{/* Location */}
										<p className="text-text-secondary/60 text-xs mb-4">{experience.location}</p>
