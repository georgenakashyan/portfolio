...
export default function ContactPage() {
	const email = process.env.NEXT_PUBLIC_MY_EMAIL || "georgenakashyan@gmail.com";
					...
					<div className="space-y-8">
						<div>
							...
							<div className="mb-6">
								...
								<p className="text-text-primary text-lg">New York, NY</p>
							</div>
						...
						<div className="p-6 bg-card-bg/40 backdrop-blur-lg border border-white/10 rounded-3xl">
							<h3 className="text-xl font-bold mb-3 text-text-primary">Let's Build Something Amazing</h3>
							<p className="text-text-secondary text-sm leading-relaxed">
								I'm always interested in new opportunities, collaborations, and challenging projects. Whether
								you have a question, a project idea, or just want to connect, feel free to reach out. I
